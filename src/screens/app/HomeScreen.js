    ...
    <ScrollView style={{flex: 1, backgroundColor: '#212244', }}>
      ...
      <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginVertical: 20, }}>
        <View style={{ flexDirection: 'row', justifyContent: 'center', alignItem: 'center', gap: 10, }}>
          ...
          />
          <View>
            <Text style={{color: 'rgba(255,255,255,0.6)', fontFamily: 'NeueRegular'}}>Welcome back</Text>
      ...
      <Text style={{textAlign: 'center', marginBottom:6, fontFamily: FONT.neueUltrabold, color: COLORS.gray}}>
          PORTFOLIO BALANCE
      </Text>
      <Text style={{textAlign: 'center', color: '#fff',fontSize: SIZES.xxLarge, fontWeight: '700',}}>
          $ 45,000
      </Text>
      <Text style={{textAlign: 'center', color: '#fff',fontSize: SIZES.medium,}}>
          + 2.4%
      </Text>
    </LinearGradient>
